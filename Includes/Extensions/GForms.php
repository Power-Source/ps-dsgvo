...
class GForms {
    ...
    /**
     * Wrapper für Gravity Forms Hook-Kompatibilität.
     * @param string $value
     * @param array  $lead
     * @param mixed  $field
     * @return string
     */
    public function addAcceptedDateToEntry($value = '', $lead = array(), $field = null) {
        return $this->processAcceptedDateToEntry($field, $lead, $value);
    }

    /**
     * Interne Methode mit korrekter Reihenfolge (kein Deprecated-Fehler mehr).
     * @param mixed  $field
     * @param array  $lead
     * @param string $value
     * @return string
     */
    private function processAcceptedDateToEntry($field, $lead = array(), $value = '') {
